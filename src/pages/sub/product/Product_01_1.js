            ...
            <div className="wrap">
                ...
                <Style.Top>
                    ...
                    <div className="content">
                        <h2>냉풍건조기 [CWCD-230D]</h2>
                        <p>
                            • 기계실치수(mm) : 길이 3,000 X 폭 1,500 X 높이 2,600 <br />
                            •  대차수(대) : 8 ~ 10대 (길이 930 X 폭 1,200 X 높이 1,645)<br />
                            •  건조물 내용량(kg) : 3,000 ~ 4,000 (건조물 종류에 따라 다를 수 있음)<br />
                            •  히트펌프용량(HP) : 15 X 2EA<br />
                            •  재열히터용량(kW) : 9.9<br />
                            •  송풍기(kW) : 1.5 X 3대<br />
                            •  제습능력(L/hr) : 32 ~ 40<br />
                            •  전원 : 3상 4P 380V 60hz<br />
                            •  용도 : 과일, 야채, 수산물, 한약재 등<br />
                            •  특징 : 기본 모델에 냉동기를 2SET를 조립하여 습량이 많을 경우 일시적으로<br />
                            제습량을 늘리거나 냉동기 1SET가 고장시 1SET는 운전되도록 하여 피건조물의 변질을 예방.
                        </p>
                        <table >
                            <tbody>
                                <tr>
                                ...
                                <tr>
                                    <td>냉동능력</td>
                                    <td>25.7kw(22, 100kcal/h) X 2EA</td>
                                    <td>재열히터</td>
                                    <td>9.9kw</td>
                                </tr>
                                <tr>
