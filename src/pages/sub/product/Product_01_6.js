...
import product from "assets/images/prodcut/6.png";
            ...
            <div className="wrap">
                ...
                <Style.Top>
                    ...
                    <div className="content">
                        <h2>냉풍건조기 [CWCD-120D]</h2>
                        <p>
                            • 기계실치수(mm) : 길이 4,000 X 폭 1,500 X 높이 2,600 <br />
                            •  대차수(대) : 10대 (길이 930 X 폭 1,200 X 높이 1,645)<br />
                            •  건조물 내용량(kg) : 4,000 (건조물 종류에 따라 상이)<br />
                            •  히트펌프용량(HP) : 20<br />
                            •  재열히터용량(kW) : 9.9<br />
                            •  송풍기(kW) : 1.5 X 4대<br />
                            •  제습능력(L/hr) : 40<br />
