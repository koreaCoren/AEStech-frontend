...
import product from "assets/images/prodcut/3.png";
            ...
            <div className="wrap">
                ...
                <Style.Top>
                    ...
                    <div className="content">
                        <h2>냉풍건조기 [CWCD-010D]</h2>
                        <p>
                            • 기계실치수(mm) : 길이 3,000 X 폭 1,500 X 높이 2,600 <br />
                            •  대차수(대) : 6대 (길이 930 X 폭 1,200 X 높이 1,645)<br />
                            •  건조물 내용량(kg) : 2,000 (건조물 종류에 따라 다를 수 있음)<br />
                            •  히트펌프용량(HP) : 10<br />
                            •  재열히터용량(kW) : 9.9 / 19.2 선택가능<br />
                            •  송풍기(kW) : 1.5 X 2대<br />
                            •  제습능력(L/hr) : 24<br />
