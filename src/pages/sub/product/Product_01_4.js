...
import product from "assets/images/prodcut/4.png";
            ...
            <div className="wrap">
                ...
                <Style.Top>
                    ...
                    <div className="content">
                        <h2>냉풍건조기 [CWCD-007C]</h2>
                        <p>
                            •  기계실치수(mm) : 길이 4,543 X 폭 1,885 X 높이 1,906 <br />
                            •  채반수(개) : 99<br />
                            •  건조물 내용량(kg) : 800 ~ 1,000 (건조물 종류에 따라 상이)<br />
                            •  히트펌프용량(HP) : 7.5<br />
                            •  재열히터용량(kW) : 6.6 / 9.9 / 13.2 / 16.5 / 19.2 선택 가능<br />
                            •  송풍기(kW) : 1.5 X 2대<br />
                            •  제습능력(L/hr) : 20<br />
